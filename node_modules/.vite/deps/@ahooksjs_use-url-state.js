import {
  dist_exports
} from "./chunk-OEHJUFEK.js";
import {
  useMemoizedFn_default,
  useUpdate_default
} from "./chunk-KIREWITA.js";
import "./chunk-U4764Y4W.js";
import "./chunk-DUZAQB23.js";
import "./chunk-3FTN53LU.js";
import "./chunk-PO5LHHKV.js";
import "./chunk-NVDFJZGF.js";
import "./chunk-DPWZCQ64.js";
import "./chunk-G3ASFRVK.js";
import "./chunk-IOV5NRVQ.js";
import {
  require_react
...
// node_modules/.pnpm/@ahooksjs+use-url-state@3.5.1_react-router@6.6.2_react@18.2.0/node_modules/@ahooksjs/use-url-state/es/index.js
...
var useUrlState = (initialState, options) => {
  var _a, _b;
  const {
    navigateMode = "push",
    parseOptions,
  ...
  const initialStateRef = (0, import_react.useRef)(typeof initialState === "function" ? initialState() : initialState || {});
  const queryFromUrl = (0, import_react.useMemo)(() => {
    return (0, import_query_string.parse)(location.search, mergedParseOptions);
  }, [location.search]);
  const targetQuery = (0, import_react.useMemo)(() => Object.assign(Object.assign({}, initialStateRef.current), queryFromUrl), [queryFromUrl]);
  const setState = (s) => {
    ...
    if (history) {
      history[navigateMode]({
        hash: location.hash,
        search: (0, import_query_string.stringify)(Object.assign(Object.assign({}, queryFromUrl), newQuery), mergedStringifyOptions) || "?"
      }, location.state);
    }
    if (navigate) {
      navigate({
  ...
  return [targetQuery, useMemoizedFn_default(setState)];
};
var es_default = useUrlState;
export {
  es_default as default
};
//# sourceMappingURL=@ahooksjs_use-url-state.js.map
