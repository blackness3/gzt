...
var nativeObjectToString = objectProto7.toString;
...
var nativeObjectToString2 = objectProto8.toString;
var invertBy = createInverter_default(function(result2, value, key) {
  if (value != null && typeof value.toString != "function") {
    value = nativeObjectToString2.call(value);
  }
  if (hasOwnProperty7.call(result2, value)) {
...
function customDefaultsAssignIn(objValue, srcValue, key, object) {
  if (objValue === void 0 || eq_default(objValue, objectProto10[key]) && !hasOwnProperty9.call(object, key)) {
    return srcValue;
  }
  return objValue;
}
...
mixin2(wrapperLodash_default, function() {
  ...
  baseForOwn_default(wrapperLodash_default, function(func, methodName) {
    if (!hasOwnProperty11.call(wrapperLodash_default.prototype, methodName)) {
...
baseForOwn_default(LazyWrapper_default.prototype, function(func, methodName) {
  ...
  if (lodashFunc) {
    ...
    if (!hasOwnProperty11.call(realNames_default, key)) {
