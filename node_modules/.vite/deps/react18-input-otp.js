...
// node_modules/.pnpm/react18-input-otp@1.1.2_react-dom@18.2.0_react@18.2.0/node_modules/react18-input-otp/lib/index.js
var require_lib = __commonJS({
  "node_modules/.pnpm/react18-input-otp@1.1.2_react-dom@18.2.0_react@18.2.0/node_modules/react18-input-otp/lib/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports["default"] = void 0;
    var _react = _interopRequireWildcard(require_react());
    var _excluded = ["placeholder", "separator", "isLastChild", "ariaLabelOverride", "shouldRender", "inputStyle", "focus", "isDisabled", "hasErrored", "errorStyle", "focusStyle", "disabledStyle", "shouldAutoFocus", "isInputNum", "index", "value", "className", "isInputSecure", "onSubmit"];
    ...
    var SingleOtpInput = function(_PureComponent) {
      ...
      _createClass(SingleOtpInput2, [{ key: "componentDidMount", value: function componentDidMount() {
        ...
        var _this$props3 = this.props, placeholder = _this$props3.placeholder, separator = _this$props3.separator, isLastChild = _this$props3.isLastChild, ariaLabelOverride = _this$props3.ariaLabelOverride, shouldRender = _this$props3.shouldRender, inputStyle = _this$props3.inputStyle, focus = _this$props3.focus, isDisabled = _this$props3.isDisabled, hasErrored = _this$props3.hasErrored, errorStyle = _this$props3.errorStyle, focusStyle = _this$props3.focusStyle, disabledStyle = _this$props3.disabledStyle, shouldAutoFocus = _this$props3.shouldAutoFocus, isInputNum = _this$props3.isInputNum, index = _this$props3.index, value = _this$props3.value, className = _this$props3.className, isInputSecure = _this$props3.isInputSecure, onSubmit = _this$props3.onSubmit, rest = _objectWithoutProperties(_this$props3, _excluded);
        return _react["default"].createElement("div", { className, style: { display: "flex", alignItems: "center" } }, _react["default"].createElement("input", _extends({ "aria-label": this.getAriaLabel(index, isInputNum), style: Object.assign({ width: "1em", textAlign: "center", padding: 0 }, isStyleObject(inputStyle) && inputStyle, focus && isStyleObject(focusStyle) && focusStyle, isDisabled && isStyleObject(disabledStyle) && disabledStyle, hasErrored && isStyleObject(errorStyle) && errorStyle), placeholder, className: this.getClasses(inputStyle, focus && focusStyle, isDisabled && disabledStyle, hasErrored && errorStyle), type: this.getType(), ref: this.input, disabled: isDisabled, value: value ? value : "" }, rest)), !isLastChild && shouldRender && separator);
      } }]);
    ...
    var OtpInput = function(_Component) {
      ...
      function OtpInput2() {
        ...
        _defineProperty(_assertThisInitialized(_this2), "focusPrevInputAndChangeCode", function(value) {
          var activeInput = _this2.state.activeInput;
          var otp = _this2.getOtpValue();
          if (otp[activeInput] != value[0]) {
            otp[activeInput] = value[0];
            if (otp[activeInput + 1] != value[0]) {
              _this2.focusInput(otp.length - 1);
            }
          } else {
            _this2.focusInput(activeInput - 1);
          }
        ...
        _defineProperty(_assertThisInitialized(_this2), "handleOnKeyDown", function(e) {
          if (e.keyCode === BACKSPACE || e.key === "Backspace") {
            e.preventDefault();
            _this2.focusPrevInputAndChangeCode("");
        ...
        _defineProperty(_assertThisInitialized(_this2), "renderInputs", function() {
          ...
          var _loop = function _loop2(i2) {
            ...
            }, separator, inputStyle, focusStyle, isLastChild: i2 === numInputs - 1, isDisabled, disabledStyle, hasErrored, errorStyle, shouldAutoFocus, isInputNum, isInputSecure, className, "data-cy": dataCy && "".concat(dataCy, "-").concat(i2), "data-testid": dataTestId && "".concat(dataTestId, "-").concat(i2), shouldRender, onSubmit }, currentInputProps, testAttr)));
          };
